...
CREATE TABLE MAINTENANCE (
    ...
    EmployyeeID			Integer 	    	NOT NULL,
    CONSTRAINT			MAINTENANCE_PK		PRIMARY KEY (Vin, MaintenanceNo, EmployyeeID),
	CONSTRAINT			MAINTENANCE_VIN_FK	FOREIGN KEY (Vin)
									REFERENCES CAR (Vin),
	CONSTRAINT			MAINTENANCE_EMP_FK		FOREIGN KEY (EmployyeeID)
									REFERENCES EMPLOYEE (EmployyeeID)
);
...
INSERT INTO CAR VALUES (
	'5XYKWDA74EG536509', 'GT-R', 'Nissan', 'White', '7BZV628', 'Sedan', 12324, '2018-02-15 09:45:00
',1);

INSERT INTO CAR VALUES (
	'5FNYF3H23EB079746', 'ACURA', 'Tsx', 'Silver', '7BZV690', 'Sedan', 12433, '2018-02-17 09:30:00
',1);
...
INSERT INTO EMPLOYEE VALUES (
	23, 'Martin E. Mayes', 'Manager', 'Yes', '2010-03-01 09:30:00','517481234', 60000.00, null);
...
INSERT INTO INSURANCE VALUES (
	1876574569, '5XYKWDA74EG536509', 1, 'Flawless', 'No repairment required' 
);
INSERT INTO INSURANCE VALUES (
	1435645754, '5FNYF3H23EB079746', 2, 'Flawless', 'No repairment required' 
);
INSERT INTO INSURANCE VALUES (
	1875678452, '5NPE34AF2FH023783', null, 'Flawless', 'No repairment required' 
);
INSERT INTO INSURANCE VALUES (
	1786758653, '3GKEC16Z96G247342', null, 'Flawless', 'No repairment required' 
);
INSERT INTO INSURANCE VALUES (
	1987644532, '1GTEK14X75Z242025', null, 'Flawless', 'No repairment required' 
);


INSERT INTO MAINTENANCE VALUES (
	1, '2018-01-01 09:30:00', '5XYKWDA74EG536509', 1001, 'No service required', 'No comment', 46 
);
INSERT INTO MAINTENANCE VALUES (
	2, '2018-01-02 09:30:00', '5FNYF3H23EB079746', 14092, 'Oil change', 'No comment', 46
);
INSERT INTO MAINTENANCE VALUES (
	3, '2018-01-03 09:30:00', '5NPE34AF2FH023783', 11001, 'Oil change', 'No comment', 46
);
INSERT INTO MAINTENANCE VALUES (
	4, '2018-01-04 09:30:00', '3GKEC16Z96G247342', 1871, 'No service required', 'No comment' ,45
);
INSERT INTO MAINTENANCE VALUES (
	5, '2018-01-05 09:30:00', '1GTEK14X75Z242025', 30005, 'Replaced brakes, oil change', 'New brake pads that should last for the next 40,000 miles' , 45
);



-- INSERT INTO RENTALPRICE VALUES (
-- 	
...
INSERT INTO INVOICE VALUES (
	1, 34.99, '2018-02-15 09:45:00', 35, 3543, 1876574569, '5XYKWDA74EG536509', 46
);
INSERT INTO INVOICE VALUES (
	2, 29.99, '2018-02-17 09:30:00', 32, 2343, 1435645754, '5FNYF3H23EB079746', 45
);
